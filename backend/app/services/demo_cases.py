...
CASES: list[DemoCase] = [
    ...
    DemoCase(
        id="expired-insurance-pimpri",
        title="Expired insurance — IRDA mismatch",
        subtitle="Old Mumbai Hwy · Pimpri corridor · 14:32 IST",
        ...
        owner_email="anjali.sharma221@example.in", owner_city="Pune",
        ...
        history={"detections_30d": 2, "repeat_offences": 0, "last_district": "Pimpri",
                 "encounter_history": [
                     {"date": "2026-05-12", "camera": "PUN-PCM-03", "result": "Clean pass"},
                     {"date": "2026-04-30", "camera": "PUN-KTJ-11", "result": "Clean pass"},
                 ]},
        location="Old Mumbai–Pune Hwy, Pimpri",
        camera_code="PUN-PCM-03",
        stages=_stages(ocr_latency=210, threat=42, has_violation=True),
    ),
    # 2 — Expired registration
    DemoCase(
        id="expired-registration-wakad",
        title="Expired registration — RTO lapse",
        subtitle="Wakad Flyover · 09:18 IST",
        ...
        owner_email="rohan.mehta54@example.in", owner_city="Pimpri-Chinchwad",
        ...
        history={"detections_30d": 4, "repeat_offences": 1, "last_district": "Wakad",
                 "encounter_history": [
                     {"date": "2026-05-19", "camera": "PUN-WKD-02", "result": "Expired Registration"},
                     {"date": "2026-05-04", "camera": "PUN-BNR-04", "result": "Clean pass"},
                     {"date": "2026-04-22", "camera": "PUN-HDP-12", "result": "Clean pass"},
                 ]},
        location="Expressway Exit, Wakad Flyover",
        camera_code="PUN-WKD-02",
    ...
    DemoCase(
        ...
        subtitle="Koregaon Park · North Main Rd · 11:04 IST",
        ...
        history={"detections_30d": 1, "repeat_offences": 0, "last_district": "Koregaon Park",
                 "encounter_history": [
                     {"date": "2026-05-10", "camera": "PUN-KP-08", "result": "Clean pass"},
                 ]},
        location="North Main Rd, Koregaon Park",
        camera_code="PUN-KP-08",
    ...
    DemoCase(
        ...
        subtitle="Katraj Chowk · NH-48 · 22:47 IST",
        ...
        owner_email="imran.khan88@example.in", owner_city="Pune",
        ...
        history={"detections_30d": 7, "repeat_offences": 4, "last_district": "Katraj",
                 "encounter_history": [
                     {"date": "2026-05-23", "camera": "PUN-KTJ-11", "result": "Blacklisted Vehicle"},
                     {"date": "2026-05-18", "camera": "PUN-KHD-09", "result": "Blacklisted Vehicle"},
                     {"date": "2026-05-09", "camera": "PUN-JMR-06", "result": "Blacklisted Vehicle"},
                     {"date": "2026-05-02", "camera": "PUN-FCR-07", "result": "Blacklisted Vehicle"},
                 ]},
        location="Satara Rd, Katraj Chowk",
        camera_code="PUN-KTJ-11",
    ...
    DemoCase(
        ...
        subtitle="JM Road · Deccan · 16:55 IST",
        ...
        owner_email="meera.iyer311@example.in", owner_city="Pune",
        ...
        history={"detections_30d": 0, "repeat_offences": 0, "last_district": "Deccan",
                 "encounter_history": []},
        location="JM Rd, Deccan Gymkhana",
        camera_code="PUN-JMR-06",
    ...
    DemoCase(
        ...
        subtitle="Baner Rd · Aundh Junction · 18:11 IST",
        ...
        owner_email="siddharth.roy90@example.in", owner_city="Pune",
        is_violation=True, violation_type="Expired Insurance",
        ...
        compliance={"registration": True, "insurance": False, "puc": True, "blacklist": False},
        history={"detections_30d": 5, "repeat_offences": 3, "last_district": "Aundh",
                 "encounter_history": [
                     {"date": "2026-05-20", "camera": "PUN-BNR-04", "result": "Expired Insurance"},
                     {"date": "2026-05-11", "camera": "PUN-HDP-12", "result": "Expired Insurance"},
                     {"date": "2026-04-29", "camera": "PUN-WKD-02", "result": "Expired Insurance"},
                 ]},
        location="Baner Rd, Aundh Junction",
        camera_code="PUN-BNR-04",
    ...
    DemoCase(
        ...
        subtitle="Swargate Junction · 03:22 IST",
        ...
        owner_email="pooja.kapoor117@example.in", owner_city="Pune",
        is_violation=True, violation_type="Blacklisted Vehicle",
        ...
        compliance={"registration": True, "insurance": True, "puc": True, "blacklist": True},
        history={"detections_30d": 1, "repeat_offences": 0, "last_district": "Swargate",
                 "encounter_history": [
                     {"date": "2026-05-22", "camera": "PUN-SWG-10", "result": "Stolen — BOLO"},
                 ]},
        location="Satara Rd, Swargate Junction",
        camera_code="PUN-SWG-10",
    ...
    DemoCase(
        ...
        subtitle="Hinjewadi Ph 2 · 19:48 IST",
        ...
        owner_email="tanvi.bhatt208@example.in", owner_city="Pune",
        is_violation=False, violation_type=None,
        ...
        compliance={"registration": True, "insurance": True, "puc": True, "blacklist": False},
        history={"detections_30d": 0, "repeat_offences": 0, "last_district": "Hinjewadi",
                 "encounter_history": []},
        location="Hinjewadi IT Park Ph 2, Main Gate",
        camera_code="PUN-HJW-01",
    ...
    DemoCase(
        ...
        subtitle="Kharadi Bypass · 23:58 IST",
        ...
        owner_email="vikram.singh412@example.in", owner_city="Pune",
        is_violation=True, violation_type="Expired Pollution Cert",
        ...
        compliance={"registration": True, "insurance": True, "puc": False, "blacklist": False},
        history={"detections_30d": 2, "repeat_offences": 0, "last_district": "Kharadi",
                 "encounter_history": [
                     {"date": "2026-05-21", "camera": "PUN-KHD-09", "result": "Clean pass"},
                     {"date": "2026-05-08", "camera": "PUN-FCR-07", "result": "Clean pass"},
                 ]},
        location="Nagar Rd Bypass, Kharadi",
        camera_code="PUN-KHD-09",
    ...
    DemoCase(
        ...
        subtitle="Old Mumbai Hwy · Pimpri · 08:09 IST",
        ...
        owner_email="nikhil.verma552@example.in", owner_city="Pune",
        is_violation=False, violation_type=None,
        ...
        compliance={"registration": True, "insurance": True, "puc": True, "blacklist": False},
        history={"detections_30d": 1, "repeat_offences": 0, "last_district": "Pimpri",
                 "encounter_history": [
                     {"date": "2026-05-14", "camera": "PUN-PCM-03", "result": "Clean pass"},
                 ]},
        location="Old Mumbai–Pune Hwy, Pimpri",
        camera_code="PUN-PCM-03",
